...
import (
	...
	apifake "kubeops.dev/statefulset/client/clientset/versioned/fake"
	apiinformers "kubeops.dev/statefulset/client/informers/externalversions"
	stsinformers "kubeops.dev/statefulset/client/informers/externalversions/apps/v1"
...
type invariantFunc func(set *api.StatefulSet, om *fakeObjectManager) error

func setupController(client clientset.Interface, apiclient versioned.Interface) (*fakeObjectManager, *fakeStatefulSetStatusUpdater, StatefulSetControlInterface) {
	...
	ssu := newFakeStatefulSetStatusUpdater(apiinformerFactory.Apps().V1().StatefulSets())
...
func burst(set *api.StatefulSet) *api.StatefulSet {
	set.Spec.PodManagementPolicy = apps.ParallelPodManagement
	return set
}

func setMinReadySeconds(set *api.StatefulSet, minReadySeconds int32) *api.StatefulSet {
...
func TestStatefulSetControl(t *testing.T) {
	simpleSetFn := func() *api.StatefulSet { return newStatefulSet(3) }
	largeSetFn := func() *api.StatefulSet { return newStatefulSet(5) }

	testCases := []struct {
		fn  func(*testing.T, *api.StatefulSet, invariantFunc)
		obj func() *api.StatefulSet
	}{
...
func CreatesPods(t *testing.T, set *api.StatefulSet, invariants invariantFunc) {
...
func ScalesUp(t *testing.T, set *api.StatefulSet, invariants invariantFunc) {
	client := fake.NewSimpleClientset(set)
	apiclient := apifake.NewSimpleClientset(set)
	om, _, ssc := setupController(client, apiclient)
...
func ScalesDown(t *testing.T, set *api.StatefulSet, invariants invariantFunc) {
	client := fake.NewSimpleClientset(set)
	apiclient := apifake.NewSimpleClientset(set)
	om, _, ssc := setupController(client, apiclient)
...
func ReplacesPods(t *testing.T, set *api.StatefulSet, invariants invariantFunc) {
	client := fake.NewSimpleClientset(set)
	apiclient := apifake.NewSimpleClientset(set)
	om, _, ssc := setupController(client, apiclient)
...
func recreatesPod(t *testing.T, set *api.StatefulSet, invariants invariantFunc, phase v1.PodPhase) {
...
func RecreatesFailedPod(t *testing.T, set *api.StatefulSet, invariants invariantFunc) {
	recreatesPod(t, set, invariants, v1.PodFailed)
}

func RecreatesSucceededPod(t *testing.T, set *api.StatefulSet, invariants invariantFunc) {
	recreatesPod(t, set, invariants, v1.PodSucceeded)
}

func CreatePodFailure(t *testing.T, set *api.StatefulSet, invariants invariantFunc) {
	client := fake.NewSimpleClientset(set)
	apiclient := apifake.NewSimpleClientset(set)
	om, _, ssc := setupController(client, apiclient)
...
func UpdatePodFailure(t *testing.T, set *api.StatefulSet, invariants invariantFunc) {
	client := fake.NewSimpleClientset(set)
	apiclient := apifake.NewSimpleClientset(set)
	om, _, ssc := setupController(client, apiclient)
...
func UpdateSetStatusFailure(t *testing.T, set *api.StatefulSet, invariants invariantFunc) {
	client := fake.NewSimpleClientset(set)
	apiclient := apifake.NewSimpleClientset(set)
...
func PodRecreateDeleteFailure(t *testing.T, set *api.StatefulSet, invariants invariantFunc) {
	client := fake.NewSimpleClientset(set)
	apiclient := apifake.NewSimpleClientset(set)
	om, _, ssc := setupController(client, apiclient)
...
func NewRevisionDeletePodFailure(t *testing.T, set *api.StatefulSet, invariants invariantFunc) {
	client := fake.NewSimpleClientset(set)
	apiclient := apifake.NewSimpleClientset(set)
	om, _, ssc := setupController(client, apiclient)
	if err := scaleUpStatefulSetControl(set, ssc, om, invariants); err != nil {
...
func emptyInvariants(set *api.StatefulSet, om *fakeObjectManager) error {
	return nil
}
...
func TestStatefulSetControlWithStartOrdinal(t *testing.T) {
	...
	simpleSetFn := func() *api.StatefulSet {
...
func CreatesPodsWithStartOrdinal(t *testing.T, set *api.StatefulSet, invariants invariantFunc) {
	client := fake.NewSimpleClientset(set)
	apiclient := apifake.NewSimpleClientset(set)
	om, _, ssc := setupController(client, apiclient)
...
func RecreatesPVCForPendingPod(t *testing.T, set *api.StatefulSet, invariants invariantFunc) {
	client := fake.NewSimpleClientset()
	apiclient := apifake.NewSimpleClientset()
	om, _, ssc := setupController(client, apiclient)
	selector, err := metav1.LabelSelectorAsSelector(set.Spec.Selector)
...
func setupPodManagementPolicy(podManagementPolicy apps.PodManagementPolicyType, set *api.StatefulSet) *api.StatefulSet {
...
func setupForInvariant(t *testing.T) (*api.StatefulSet, *fakeObjectManager, StatefulSetControlInterface, intstr.IntOrString, int32) {
	var totalPods int32 = 6
...
func TestStatefulSetControlRollingUpdate(t *testing.T) {
	type testcase struct {
		name       string
		invariants func(set *api.StatefulSet, om *fakeObjectManager) error
		initial    func() *api.StatefulSet
		update     func(set *api.StatefulSet) *api.StatefulSet
		validate   func(set *api.StatefulSet, pods []*v1.Pod) error
	}
...
func TestStatefulSetControlOnDeleteUpdate(t *testing.T) {
	type testcase struct {
		...
		initial         func() *api.StatefulSet
		update          func(set *api.StatefulSet) *api.StatefulSet
		validateUpdate  func(set *api.StatefulSet, pods []*v1.Pod) error
		validateRestart func(set *api.StatefulSet, pods []*v1.Pod) error
	}
...
func TestStatefulSetControlRollback(t *testing.T) {
	type testcase struct {
		...
		update           func(set *api.StatefulSet) *api.StatefulSet
		validateUpdate   func(set *api.StatefulSet, pods []*v1.Pod) error
		validateRollback func(set *api.StatefulSet, pods []*v1.Pod) error
	}
...
type fakeObjectManager struct {
	...
	setsLister       apilisters.StatefulSetLister
...
func newFakeObjectManager(informerFactory informers.SharedInformerFactory, apiinformerFactory apiinformers.SharedInformerFactory) *fakeObjectManager {
	...
	setInformer := apiinformerFactory.Apps().V1().StatefulSets()
...
func (om *fakeObjectManager) setPodPending(set *api.StatefulSet, ordinal int) ([]*v1.Pod, error) {
	selector, err := metav1.LabelSelectorAsSelector(set.Spec.Selector)
	if err != nil {
		return nil, err
	}
...
func (om *fakeObjectManager) setPodRunning(set *api.StatefulSet, ordinal int) ([]*v1.Pod, error) {
	selector, err := metav1.LabelSelectorAsSelector(set.Spec.Selector)
	if err != nil {
		return nil, err
	}
...
func (om *fakeObjectManager) setPodReady(set *api.StatefulSet, ordinal int) ([]*v1.Pod, error) {
	selector, err := metav1.LabelSelectorAsSelector(set.Spec.Selector)
	if err != nil {
		return nil, err
	}
...
func (om *fakeObjectManager) setPodAvailable(set *api.StatefulSet, ordinal int, lastTransitionTime time.Time) ([]*v1.Pod, error) {
	selector, err := metav1.LabelSelectorAsSelector(set.Spec.Selector)
	if err != nil {
		return nil, err
	}
...
func (om *fakeObjectManager) addTerminatingPod(set *api.StatefulSet, ordinal int) ([]*v1.Pod, error) {
...
func (om *fakeObjectManager) setPodTerminated(set *api.StatefulSet, ordinal int) ([]*v1.Pod, error) {
	pod := newStatefulSetPod(set, ordinal)
	deleted := metav1.NewTime(time.Now())
	pod.DeletionTimestamp = &deleted
	fakeResourceVersion(pod)
...
func newFakeStatefulSetStatusUpdater(setInformer stsinformers.StatefulSetInformer) *fakeStatefulSetStatusUpdater {
...
func (ssu *fakeStatefulSetStatusUpdater) UpdateStatefulSetStatus(ctx context.Context, set *api.StatefulSet, status *apps.StatefulSetStatus) error {
...
func assertMonotonicInvariants(set *api.StatefulSet, om *fakeObjectManager) error {
	selector, err := metav1.LabelSelectorAsSelector(set.Spec.Selector)
	if err != nil {
		return err
	}
...
func assertBurstInvariants(set *api.StatefulSet, om *fakeObjectManager) error {
	selector, err := metav1.LabelSelectorAsSelector(set.Spec.Selector)
	if err != nil {
		return err
	}
...
func assertUpdateInvariants(set *api.StatefulSet, om *fakeObjectManager) error {
	selector, err := metav1.LabelSelectorAsSelector(set.Spec.Selector)
	if err != nil {
		return err
	}
...
func checkClaimInvarients(set *api.StatefulSet, pod *v1.Pod, claim *v1.PersistentVolumeClaim) error {
...
func parallelScale(t *testing.T, set *api.StatefulSet, replicas, desiredReplicas int32, invariants invariantFunc) {
	var err error
...
func parallelScaleUpStatefulSetControl(set *api.StatefulSet,
	ssc StatefulSetControlInterface,
...
func parallelScaleDownStatefulSetControl(set *api.StatefulSet, ssc StatefulSetControlInterface, om *fakeObjectManager, invariants invariantFunc) error {
	selector, err := metav1.LabelSelectorAsSelector(set.Spec.Selector)
	if err != nil {
		return err
	}
...
func scaleUpStatefulSetControl(set *api.StatefulSet,
	ssc StatefulSetControlInterface,
	om *fakeObjectManager,
	invariants invariantFunc,
) error {
...
func scaleDownStatefulSetControl(set *api.StatefulSet, ssc StatefulSetControlInterface, om *fakeObjectManager, invariants invariantFunc) error {
	selector, err := metav1.LabelSelectorAsSelector(set.Spec.Selector)
	if err != nil {
		return err
	}
...
func updateComplete(set *api.StatefulSet, pods []*v1.Pod) bool {
	sort.Sort(ascendingOrdinal(pods))
...
func updateStatefulSetControl(set *api.StatefulSet,
	ssc StatefulSetControlInterface,
	om *fakeObjectManager,
	invariants invariantFunc,
) error {
...
func newRevisionOrDie(set *api.StatefulSet, revision int64) *apps.ControllerRevision {
